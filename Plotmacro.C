...
TH1D *EtaTau2 = (TH1D*) f->Get("h_EtaTau2");
  ...
  ETau1boosted->GetYaxis()->SetTitle("Counts/0.05 GeV");
  ...
  PhiTau2boosted->GetYaxis()->SetTitle("Counts/0.062 rad");
  ...
  ETau2boosted->GetYaxis()->SetTitle("Counts/0.05 GeV");
  ...
  PhiTau1Vis->GetYaxis()->SetTitle("Counts/0.062 rad");
  ...
  PhiTau2Vis->GetYaxis()->SetTitle("Counts/0.062 rad");
  ...
  PhiMET->GetYaxis()->SetTitle("Counts/0.062rad");
  ...
  PhiMETwithsigma->GetYaxis()->SetTitle("Counts/0.062rad");
